...
###
if len(sys.argv) != 3:
    print("Error:  number of file paths provided is not correct.")
    print("Usage: python script.py arg1 arg2 ")
else:
    gitClass_file_path = sys.argv[1]
    classData_file_path = sys.argv[2]

    print("File 1:", gitClass_file_path)
    print("File 2:", classData_file_path)
